...
function loadPlanets(){
	// use variable planets from planets.js to create spheres
	// make sure to pass the params.name to render the planet images
	// tilt is the orbital inclination
//------------------- BEGIN YOUR CODE
...
// uncomment this in the end for correct lighting!!!
	scene.add(spotLight);
	scene.remove(light);
